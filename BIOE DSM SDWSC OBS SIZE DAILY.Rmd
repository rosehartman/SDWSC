...
ggplot(obj3_sgr_evenlength, aes(x = Year, y = SGR, color = Site)) + geom_point()+ 
  ...
  theme_bw()+scale_color_manual(values = c("blue2","skyblue","navy", "purple2", "orange2", "red2"))
...
write.csv(obj3_sgr_evenlength, "outputs/AveGrowthByYear.csv", row.names = F)
```
